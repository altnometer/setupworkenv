...
(my-with-elapsed-timer "Loading config/config.org"
  (when (file-readable-p "~/.emacs.d/config/config.org")
...
")
 ...
 '(org-agenda-files
   (quote
    ("~/backup/books/clojure/the.joy.of.clojre/the.joy.of.clojure.org")))
 '(pos-tip-background-color "#073642")
 '(pos-tip-foreground-color "#93a1a1")
 '(prescient-filter-method (quote (fuzzy initialism regexp)))
